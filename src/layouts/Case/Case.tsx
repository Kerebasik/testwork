...
const Case = () => {
  return (
    <div className={'case'} id={'our-cases'}>
      <div className={'case__content'}>
        <div className={'case__content__menu'}>
          <div className={'line'}></div>
          <p className={'case__content__menu__item_selected'}>
            Зелений кооператив
          </p>
        ...
        <div className={'case__content__data'}>
          <div className={'case__content__data__left'}>
            <div className={'case__content__data__left__header'}>
              ...
              <p>
                Компанія "Розбудова кооперативів" успішно реалізувала проєкт
                "Зелений кооператив", що забезпечив створення екологічної
                спільноти. Резиденти кооперативу заощаджують на комунальних
                послугах, активно взаємодіють між собою та сприяють збереженню
                довкілля. Цей проєкт став прикладом сталого розвитку та
                популяризації екологічних ініціатив у будівництві.
              </p>
            </div>
