...
import {RegularValidationForName, RegularValidationForPhone} from "../../constants/regExpForForm";
            ...
            <div className={'question-form__content'}>
                <form onSubmit={handleSubmit(handleOnSubmit)}>
                    <div className={'form__header'}>
                        ...
                        <p className={'form__subtitle'}>Заповніть форма у наші консультанти звяжуться з вами у найближчий час</p>
                    </div>
                ...
                <div className={'question-form__content__right'}>
                    <div className={'contacts'}>
                        ...
                        <div className={'contacts__data'}>
                            <div className={'contacts__data__number'}><div><img src={phone_icon} alt={'Phone icon'}/></div> 8 800 657 59 81</div>
                            <div className={'contacts__data__mail'}><div><img src={mail_icon} alt={'Mail icon'}/></div>buildingcooperatives@mail.ua</div>
                            <div className={'contacts__data__location'}><div><img src={point__icon} alt={'Location point icon'}/></div>36231, Івано-Франківська область, місто Івано-Франківськ, вул. Прорізна, 81</div>
                        </div>
                    </div>
